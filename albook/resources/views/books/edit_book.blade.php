...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
        <div class="card-header">Edit Book {{$books->title}}</div>
...
<label for="section_id">Books</label>
<select class="form-control" name="section_id" id="section_id" >


@foreach ($Sections as $section)
@if ($section->id == $books->section_id)
...
{{--
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" name="content" id="content" row="8" cols="8" >{!! $books->content !!}</textarea>
  </div>
